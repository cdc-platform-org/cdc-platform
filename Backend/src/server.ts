...
import iakoRoutes from './routes/iako';
import adminIakoRoutes from './routes/adminIako';
import adminAccessGrantRoutes from './routes/adminAccessGrants';
import adminLiveTrainingEnrollmentRoutes from './routes/adminLiveTrainingEnrollments';
import liveTrainingInviteRoutes from './routes/liveTrainingInvites';
import adminTrainerRoutes from './routes/adminTrainers';
import adminLiveTrainingTrainerRoutes from './routes/adminLiveTrainingTrainers';
import trainerWorkspaceRoutes from './routes/trainerWorkspace';
import digitalToolRoutes from './routes/digitalTools';
...
import careerQuizRoutes from './routes/careerQuiz';
...
import adminSystemToolsRoutes from './routes/adminSystemTools';
import adminAnalyticsRoutes from './routes/adminAnalytics';
import adminCommissionsRoutes from './routes/adminCommissions';
...
import educatorHubRoutes from './routes/educatorHub';
import teacherQuizRoutes from './routes/teacherQuiz';
import examProctoringRoutes from './routes/examProctoring';
import proctoredPracticeRoutes from './routes/proctoredPractice';
...
app.use('/api/iako', iakoRoutes);
app.use('/api/admin/iako', adminIakoRoutes);
app.use('/api/admin/access-grants', adminAccessGrantRoutes);
app.use('/api/admin/live-trainings', adminLiveTrainingEnrollmentRoutes);
app.use('/api/live-trainings/invites', liveTrainingInviteRoutes);
app.use('/api/admin/trainers', adminTrainerRoutes);
app.use('/api/admin/live-trainings', adminLiveTrainingTrainerRoutes);
app.use('/api/trainer', trainerWorkspaceRoutes);
app.use('/api/digital-tools', digitalToolRoutes);
...
app.use('/api/proctored-practice', proctoredPracticeRoutes);
...
app.use('/api/admin/system-tools', adminSystemToolsRoutes);
...
app.use('/api/educator-hub', educatorHubRoutes);
app.use('/api/quiz', teacherQuizRoutes);
