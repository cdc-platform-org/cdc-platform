...
const LABELS: Record<SupportedLocale, { github: string; facebook: string }> = {
  ka: { github: 'GitHub-ით შესვლა', facebook: 'Facebook-ით შესვლა' },
  en: { github: 'Continue with GitHub', facebook: 'Continue with Facebook' },
  de: { github: 'Mit GitHub fortfahren', facebook: 'Mit Facebook fortfahren' },
  es: { github: 'Continuar con GitHub', facebook: 'Continuar con Facebook' },
  fr: { github: 'Continuer avec GitHub', facebook: 'Continuer avec Facebook' },
  uk: { github: 'Продовжити з GitHub', facebook: 'Продовжити з Facebook' },
};
  ...
  return (
    <div className="space-y-2.5">
      ...
      <a
        ...
        className="w-full min-h-12 flex items-center justify-center gap-2.5 rounded-xl border border-[#1877F2] bg-[#1877F2] px-4 py-3 text-sm font-semibold text-white no-underline shadow-sm transition-all hover:-translate-y-0.5 hover:opacity-95"
      >
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
