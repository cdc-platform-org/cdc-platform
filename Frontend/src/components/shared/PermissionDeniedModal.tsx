...
import { ShieldAlert, Clock, Ban, XCircle, MailQuestion } from 'lucide-react';
...
const EN_STRINGS = {
  titles: {
    ...
    MONTHLY_LIMIT: "You've reached your monthly posting limit",
  ...
  bodies: {
    ...
    MONTHLY_LIMIT: 'Free accounts have a monthly posting limit. It resets next month — or contact support about upgrading.',
...
const dict = {
  ka: {
    titles: {
      ...
      MONTHLY_LIMIT: 'გამოქვეყნების ყოველთვიური ლიმიტი ამოწურულია',
    ...
    bodies: {
      ...
      MONTHLY_LIMIT: 'უფასო ანგარიშებს აქვთ გამოქვეყნების ყოველთვიური ლიმიტი. ის განახლდება მომდევნო თვეს — ან დაგვიკავშირდით განახლების თაობაზე.',
