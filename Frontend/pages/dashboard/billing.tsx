...
const dict = {
  ...
  de: {
    title: 'Abrechnung',
    subtitle: 'Ihre aktiven Business-Tool-Abonnements, die Kosten des aktuellen Zyklus und Rechnungen.',
    fallback: 'Die Abrechnungsseite steht nur Business-Konten und Administratoren zur Verfügung.',
    loading: 'Wird geladen…',
    loadFailed: 'Abrechnungsdaten konnten nicht geladen werden.',
    empty: 'Sie haben noch keine aktiven Abonnements.',
    emptyCta: 'Kostenlose Testphase der KI-Tools starten →',
    productLabel: { AI_AGENT_SUITE: 'KI-Agenten-Paket' },
    status: {
      TRIALING: 'Testphase',
      ACTIVE: 'Aktiv',
    ...
    trialEndsAt: (date: string) => `Testphase endet: ${new Date(date).toLocaleDateString('de-DE')}`,
    baseFee: 'Plattform-Grundgebühr',
    usage: 'Echtzeit-Nutzungszähler',
    total: 'Geschätzter monatlicher Gesamtbetrag',
    perMonth: '/Monat',
    autoRenew: 'Automatische Zahlung',
    on: 'Ein',
    off: 'Aus',
    card: 'Karte',
    noCard: 'Keine Karte hinterlegt',
    invoicesTitle: 'Rechnungen & Zahlungsverlauf',
    downloadInvoice: 'PDF-Rechnung herunterladen',
    downloading: 'Wird heruntergeladen…',
    invoiceEstimateNote: 'Dies ist eine Schätzung für den aktuellen Zyklus — die tatsächliche Abrechnung ist noch nicht aktiviert.',
    downloadFailed: 'Die Rechnung konnte nicht heruntergeladen werden.',
    cancelSubscription: 'Abonnement kündigen',
    canceling: 'Wird gekündigt…',
    cancelModalTitle: 'Abonnement kündigen',
    cancelModalWarning: 'Sind Sie sicher? Durch die Kündigung dieses Abonnements wird Ihr unbegrenzter Zugriff auf diesen Dienst sofort widerrufen.',
    cancelModalConfirm: 'Ja, kündigen',
    cancelModalBack: 'Zurück',
    cancelFailed: 'Das Abonnement konnte nicht gekündigt werden.',
    canceledNote: 'Abonnement gekündigt — der unbegrenzte Zugriff wurde widerrufen.',
  },
  es: {
    title: 'Facturación',
    subtitle: 'Tus suscripciones activas a herramientas empresariales, el coste del ciclo actual y las facturas.',
    fallback: 'La página de facturación solo está disponible para cuentas empresariales y administradores.',
    loading: 'Cargando…',
    loadFailed: 'No se pudieron cargar los datos de facturación.',
    empty: 'Todavía no tienes ninguna suscripción activa.',
    emptyCta: 'Inicia una prueba gratuita de herramientas de IA →',
    productLabel: { AI_AGENT_SUITE: 'Paquete de agentes de IA' },
    status: {
      TRIALING: 'Prueba',
      ACTIVE: 'Activa',
    ...
    trialEndsAt: (date: string) => `La prueba termina: ${new Date(date).toLocaleDateString('es-ES')}`,
    baseFee: 'Cuota base de mantenimiento de la plataforma',
    usage: 'Contador de uso en tiempo real',
    total: 'Total mensual estimado',
    perMonth: '/mes',
    autoRenew: 'Pago automático',
    on: 'Activado',
    off: 'Desactivado',
    card: 'Tarjeta',
    noCard: 'No hay ninguna tarjeta vinculada',
    invoicesTitle: 'Facturas e historial de pagos',
    downloadInvoice: 'Descargar factura en PDF',
    downloading: 'Descargando…',
    invoiceEstimateNote: 'Esto es una estimación del ciclo actual — el cobro real todavía no está activado.',
    downloadFailed: 'No se pudo descargar la factura.',
    cancelSubscription: 'Cancelar suscripción',
    canceling: 'Cancelando…',
    cancelModalTitle: 'Cancelar suscripción',
    cancelModalWarning: '¿Estás seguro? Al cancelar esta suscripción perderás de inmediato tu acceso ilimitado a este servicio.',
    cancelModalConfirm: 'Sí, cancelar',
    cancelModalBack: 'Volver',
    cancelFailed: 'No se pudo cancelar la suscripción.',
    canceledNote: 'Suscripción cancelada — el acceso ilimitado ha sido revocado.',
  },
  fr: {
    title: 'Facturation',
    subtitle: 'Vos abonnements actifs aux outils professionnels, le coût du cycle en cours et vos factures.',
    fallback: "La page de facturation n'est accessible qu'aux comptes professionnels et aux administrateurs.",
    loading: 'Chargement…',
    loadFailed: 'Impossible de charger les données de facturation.',
    empty: "Vous n'avez encore aucun abonnement actif.",
    emptyCta: "Démarrer un essai gratuit des outils d'IA →",
    productLabel: { AI_AGENT_SUITE: "Pack d'agents IA" },
    status: {
    ...
    trialEndsAt: (date: string) => `Fin de la période d'essai : ${new Date(date).toLocaleDateString('fr-FR')}`,
    baseFee: 'Frais de base de la plateforme',
    usage: "Compteur d'utilisation en temps réel",
    total: 'Total mensuel estimé',
    perMonth: '/mois',
    autoRenew: 'Paiement automatique',
    on: 'Activé',
    off: 'Désactivé',
    card: 'Carte',
    noCard: 'Aucune carte liée',
    invoicesTitle: 'Factures et historique des paiements',
    downloadInvoice: 'Télécharger la facture PDF',
    downloading: 'Téléchargement…',
    invoiceEstimateNote: "Il s'agit d'une estimation pour le cycle en cours — la facturation réelle n'est pas encore activée.",
    downloadFailed: 'Impossible de télécharger la facture.',
    cancelSubscription: "Annuler l'abonnement",
    canceling: 'Annulation…',
    cancelModalTitle: "Annuler l'abonnement",
    cancelModalWarning: 'Êtes-vous sûr ? En annulant cet abonnement, vous perdrez immédiatement votre accès illimité à ce service.',
    cancelModalConfirm: 'Oui, annuler',
    cancelModalBack: 'Retour',
    cancelFailed: "Impossible d'annuler l'abonnement.",
    canceledNote: 'Abonnement annulé — l\'accès illimité a été révoqué.',
  },
  uk: {
    title: 'Білінг',
    subtitle: 'Ваші активні підписки на бізнес-інструменти, вартість поточного циклу та рахунки.',
    fallback: 'Сторінка білінгу доступна лише для бізнес-акаунтів та адміністраторів.',
    loading: 'Завантаження…',
    loadFailed: 'Не вдалося завантажити дані білінгу.',
    empty: 'У вас ще немає активних підписок.',
    emptyCta: 'Розпочати безкоштовний пробний період AI-інструментів →',
    productLabel: { AI_AGENT_SUITE: 'Пакет AI-агентів' },
    status: {
    ...
    trialEndsAt: (date: string) => `Пробний період завершується: ${new Date(date).toLocaleDateString('uk-UA')}`,
    baseFee: 'Базова платформна комісія',
    usage: 'Лічильник використання в реальному часі',
    total: 'Орієнтовна щомісячна сума',
    perMonth: '/міс',
    autoRenew: 'Автоматична оплата',
    on: 'Увімкнено',
    off: 'Вимкнено',
    card: 'Картка',
    noCard: 'Картку не прив’язано',
    invoicesTitle: 'Рахунки та історія платежів',
    downloadInvoice: 'Завантажити PDF-рахунок',
    downloading: 'Завантаження…',
    invoiceEstimateNote: 'Це орієнтовна оцінка поточного циклу — реальне списання коштів ще не увімкнено.',
    downloadFailed: 'Не вдалося завантажити рахунок.',
    cancelSubscription: 'Скасувати підписку',
    canceling: 'Скасування…',
    cancelModalTitle: 'Скасувати підписку',
    cancelModalWarning: 'Ви впевнені? Скасування цієї підписки негайно відкличе ваш необмежений доступ до цього сервісу.',
    cancelModalConfirm: 'Так, скасувати',
    cancelModalBack: 'Назад',
    cancelFailed: 'Не вдалося скасувати підписку.',
    canceledNote: 'Підписку скасовано — необмежений доступ відкликано.',
  },
};
